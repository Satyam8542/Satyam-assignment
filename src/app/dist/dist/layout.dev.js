...
function RootLayout(_a) {
  ...
  return React.createElement("html", {
    ...
    className: "w-full bg-white text-black shadow-sm sticky top-0 z-50"
    ...
    className: "hidden md:flex gap-6 text-sm font-medium items-left justify-left"
  }, React.createElement("a", {
    href: "/",
    className: "hover:text-blue-600"
  }, "Find Doctors"), React.createElement("a", {
    href: "#",
    className: "hover:text-blue-600"
  }, "Video Consult"), React.createElement("a", {
    href: "#",
    className: "hover:text-blue-600"
  }, "Surgeries")), React.createElement("div", {
    className: "dropdown"
  }, React.createElement("button", {
    className: "dropbtn"
  }, "Menu", React.createElement("i", {
    ...
    href: "#"
  }, "Contact"))), React.createElement("div", null, React.createElement("button", {
    className: "text-sm hover:text-blue-600"
  }, "Login"), React.createElement("button", {
    className: "text-sm hover:bg-blue-700"
  }, "Sign up")))), React.createElement("main", null, children)));
}
